[![Build Status](https://dev.azure.com/RaviPinnamaneni/ContosoAir/_apis/build/status/kishorepi.ContosoAir?branchName=master)](https://dev.azure.com/RaviPinnamaneni/ContosoAir/_build/latest?definitionId=2&branchName=master)
